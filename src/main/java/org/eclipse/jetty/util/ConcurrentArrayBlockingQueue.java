...
/**
 * Common functionality for a blocking version of {@link org.eclipse.jetty.util.ConcurrentArrayQueue}.
 *
 * @see Unbounded
 * @see Bounded
 * @param <E>
...
public abstract class ConcurrentArrayBlockingQueue<E> extends ConcurrentArrayQueue<E> implements BlockingQueue<E>
{
    ...
    /**
     * An unbounded, blocking version of {@link org.eclipse.jetty.util.ConcurrentArrayQueue}.
     *
     * @param <E>
     */
    ...
    /**
     * A bounded, blocking version of {@link org.eclipse.jetty.util.ConcurrentArrayQueue}.
     *
     * @param <E>
     */
